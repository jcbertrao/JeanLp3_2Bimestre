...
//        painelBotoes.add(btnRem);
            ...
            public void actionPerformed(ActionEvent evt) {
                if (table.getSelectedRow() >= 0) {
                    ...
                    if (JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(cp,
                            "Confirme a exclusão [" + tableModel.getValue(table.getSelectedRow()).getCodMarca()+ " - "
        ...
        btnAdd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                marca.setCodMarca(daoMarca.autoIdMarca());
                marca.setNome("Nome");

                try {
                    Marca c = daoMarca.obter(marca.getCodMarca());
                    if (c == null) {
                    ...
                    JOptionPane.showMessageDialog(cp, "Erro ao inserir =>" + marca.getCodMarca()
