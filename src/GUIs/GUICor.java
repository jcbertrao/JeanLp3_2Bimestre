...
//        painelBotoes.add(btnRem);
            ...
            public void actionPerformed(ActionEvent evt) {
                if (table.getSelectedRow() >= 0) {
                    ...
                    if (JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(cp,
                            "Confirme a exclusão [" + tableModel.getValue(table.getSelectedRow()).getCodCor()+ " - "
        ...
        btnAdd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                marca.setCodCor(daoCor.autoIdCor());
                marca.setNome("Nome");

                try {
                    Cor c = daoCor.obter(marca.getCodCor());
                    if (c == null) {
                        daoCor.inserir(marca);
                    ...
                    JOptionPane.showMessageDialog(cp, "Erro ao inserir =>" + marca.getCodCor()
